...
$numero_facture = $_GET['numero'] ?? '';
$email = $_GET['email'] ?? '';

if (empty($numero_facture) || empty($email)) {
...
$sql = "SELECT f.*, c.client_nom, c.client_email 
        FROM factures f
        JOIN commandes c ON f.commande_id = c.id
        WHERE f.numero_facture = :numero 
        AND c.client_email = :email";
        
$stmt = $db->prepare($sql);
$stmt->execute([':numero' => $numero_facture, ':email' => $email]);
$facture = $stmt->fetch();
...
// Rediriger vers un PDF ou afficher la facture
header('Location: admin/exports/export_pdf.php?facture_id=' . $facture['id'] . '&client_view=true');
exit;
?>
<!DOCTYPE html>
<html lang="fr">
    ...
    <div class="admin-container">
        ...
        <div class="main-content">
            <div class="actions-bar">
                ...
                <a href="./admin/exports/export_pdf.php?php echo $facture_id; ?>" class="btn btn-pdf" target="_blank">
            ...
            <div class="invoice-container">
                ...
                <div class="totals">
                    ...
                    <div class="total-row">
                        <span>TVA (<?php echo $facture['tva']; ?>%):</span>
                        <span>
